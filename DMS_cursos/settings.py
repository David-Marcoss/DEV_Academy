"""
Django settings for DMS_cursos project.
...
SECRET_KEY = 'django-insecure-120!lv!d%oln$(o8f7(r@6545a*s&t4e6_pz0qo9s_d*1a-reu'
...
WSGI_APPLICATION = 'DMS_cursos.wsgi.application'
